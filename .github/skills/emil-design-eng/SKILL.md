...
description: This skill encodes Emil Kowalski's philosophy on UI polish, component design, animation decisions, and the invisible details that make software feel great. ONLY USE when the user explicitly invokes `/emil-design-eng` or specifically asks for Emil Kowalski's design engineering style/philosophy. Do NOT auto-trigger on general frontend, polish, animation, or redesign requests; `impeccable` remains the default for those.
---
