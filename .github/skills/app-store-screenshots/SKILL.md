...
description: Use when the user explicitly wants to create App Store or Google Play listing screenshots, feature graphics, exportable mobile marketing assets, or scaffold a dedicated screenshot editor for iOS/Android store listings. Triggers: app store screenshots, play store screenshots, app listing screenshots, feature graphic, screenshot generator, mobile marketing screenshots. Do NOT use for general frontend UI work, landing pages, or normal image-to-code tasks.
---
