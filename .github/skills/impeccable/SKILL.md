---
name: impeccable
description: Default skill for production frontend work. Use for design, redesign, audit, polish, UX improvements, visual hierarchy, accessibility, responsive behavior, and interaction quality across websites, dashboards, and components. Not for backend-only tasks.
version: 3.1.1
user-invocable: true
